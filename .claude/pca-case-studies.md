# GCP PCA Case Studies — Source Material

Captured 2026-05-21 from the v6.1 official exam guide PDFs. Use as authoritative source when authoring case-study-bound questions.

**Note on reproduction:** Google publishes these case studies publicly as PCA exam preparation material. The full scenario text should be embedded in the `caseStudy` table the architect designs, so practice-app users have the same context they'd see in the real exam. Consider whether to reproduce verbatim or paraphrase — confirm with user before authoring.

---

## 1. Altostrat Media

**Industry:** Media (audio + video — podcasts, interviews, news, documentaries)
**Slug suggestion:** `altostrat-media`
...
### Solution Concept
Cymbal wants to modernize its operations and enhance the customer experience in three core areas:
...
### Executive Statement
By implementing Google Cloud's Generative AI for Digital Commerce solutions, Cymbal can transform its online retail operations to improve efficiency, enhance customer experience, and drive revenue growth. Key benefits for Cymbal include:
...
**Slug suggestion:** `ehr-healthcare`
...
**Industry:** Automotive (autonomous vehicles, BEV/hybrid/ICE manufacturer)
**Slug suggestion:** `knightmotives-automotive`
...
## Official exam guide — Section weights (for question distribution)

| Section | Title | Weight | Target /300 questions |
|---|---|---|---|
| 1 | Designing and planning a cloud solution architecture | 25% | 75 |
| 2 | Managing and provisioning a cloud solution infrastructure | 17.5% | 53 |
| 3 | Designing for security and compliance | 17.5% | 53 |
| 4 | Analyzing and optimizing technical and business processes | 15% | 45 |
| 5 | Managing implementation | 12.5% | 37 |
| 6 | Ensuring solution and operations excellence | 12.5% | 37 |

Of the 300 questions: **60 are case-study-bound** (15 per case study, separate batch). The remaining 240 are standalone and follow the section weights above proportionally.

## Notable subtopics introduced in v6.1 (must be covered)

- Google Cloud Well-Architected Framework (six pillars: operational excellence, security, reliability, performance, cost, sustainability)
- Gemini Cloud Assist (Section 1.2, 5.1)
- Vertex AI pipelines + AI Hypercomputer (Section 2.4)
- Gemini Enterprise features (AI Agents, NotebookLM), Model Garden (Section 2.5)
- Securing AI: Model Armor, Sensitive Data Protection, secure model deployment (Section 3.1)
- Private Service Connect, shared VPC, Cloud Run, Cloud Run functions (Section 1.3)
- Migration Center (Section 1.4)
- Workload Identity Federation, Chrome Enterprise Premium, IAP, service account impersonation (Section 3.1)
